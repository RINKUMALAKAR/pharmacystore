...
con.prepareStatement("UPDATE product SET "
	...
	public int getQuantityOfProduct(int pid) {
		try (Connection con = 
				DbConnection.getDatabaseConnection()){
							...
							PreparedStatement pst = 
				con.prepareStatement("select quantity from "
	...
	@Override
	public boolean updateQuantityAfterCancellation(
			int pid , int quantity) {
		
		try(Connection con = DbConnection.getDatabaseConnection()){
			
			PreparedStatement pst = 
			con.prepareStatement("SELECT quantity"
